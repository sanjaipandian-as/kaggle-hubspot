...
export declare class TablesApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getAllDraftTables(sort?: Array<string>, after?: string, limit?: number, createdAt?: Date, createdAfter?: Date, createdBefore?: Date, updatedAt?: Date, updatedAfter?: Date, updatedBefore?: Date, contentType?: string, archived?: boolean, isGetLocalizedSchema?: boolean, _options?: Configuration): Promise<RequestContext>;
    getAllTables(sort?: Array<string>, after?: string, limit?: number, createdAt?: Date, createdAfter?: Date, createdBefore?: Date, updatedAt?: Date, updatedAfter?: Date, updatedBefore?: Date, contentType?: string, archived?: boolean, isGetLocalizedSchema?: boolean, _options?: Configuration): Promise<RequestContext>;
    ...
    removeTableVersion(tableIdOrName: string, versionId: number, _options?: Configuration): Promise<RequestContext>;
...
export declare class TablesApiResponseProcessor {
    ...
    removeTableVersionWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void>>;
