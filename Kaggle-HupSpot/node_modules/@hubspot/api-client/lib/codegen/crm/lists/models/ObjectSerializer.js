...
__exportStar(require("../models/PublicListConversionDate"), exports);
__exportStar(require("../models/PublicListConversionInactivity"), exports);
__exportStar(require("../models/PublicListConversionResponse"), exports);
__exportStar(require("../models/PublicListConversionResponseRequestedConversionTime"), exports);
__exportStar(require("../models/PublicListConversionTime"), exports);
__exportStar(require("../models/PublicListFolder"), exports);
__exportStar(require("../models/PublicListPermissions"), exports);
__exportStar(require("../models/PublicMembershipSettings"), exports);
...
const PublicListConversionDate_1 = require("../models/PublicListConversionDate");
const PublicListConversionInactivity_1 = require("../models/PublicListConversionInactivity");
const PublicListConversionResponse_1 = require("../models/PublicListConversionResponse");
const PublicListConversionResponseRequestedConversionTime_1 = require("../models/PublicListConversionResponseRequestedConversionTime");
const PublicListConversionTime_1 = require("../models/PublicListConversionTime");
const PublicListFolder_1 = require("../models/PublicListFolder");
const PublicListPermissions_1 = require("../models/PublicListPermissions");
const PublicMembershipSettings_1 = require("../models/PublicMembershipSettings");
...
let typeMap = {
    ...
    "PublicListConversionDate": PublicListConversionDate_1.PublicListConversionDate,
    "PublicListConversionInactivity": PublicListConversionInactivity_1.PublicListConversionInactivity,
    "PublicListConversionResponse": PublicListConversionResponse_1.PublicListConversionResponse,
    "PublicListConversionResponseRequestedConversionTime": PublicListConversionResponseRequestedConversionTime_1.PublicListConversionResponseRequestedConversionTimeClass,
    "PublicListConversionTime": PublicListConversionTime_1.PublicListConversionTimeClass,
    "PublicListFolder": PublicListFolder_1.PublicListFolder,
    "PublicListPermissions": PublicListPermissions_1.PublicListPermissions,
    "PublicMembershipSettings": PublicMembershipSettings_1.PublicMembershipSettings,
