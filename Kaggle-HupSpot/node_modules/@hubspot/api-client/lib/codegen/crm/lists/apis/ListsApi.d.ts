...
export declare class ListsApiRequestFactory extends BaseAPIRequestFactory {
    cancelConversion(listId: string, _options?: Configuration): Promise<RequestContext>;
    ...
    getConversionDetails(listId: string, _options?: Configuration): Promise<RequestContext>;
    ...
    scheduleOrUpdateConversion(listId: string, publicListConversionTime: PublicListConversionTime, _options?: Configuration): Promise<RequestContext>;
...
export declare class ListsApiResponseProcessor {
    cancelConversionWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void>>;
    ...
    getConversionDetailsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PublicListConversionResponse>>;
    ...
    scheduleOrUpdateConversionWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PublicListConversionResponse>>;
