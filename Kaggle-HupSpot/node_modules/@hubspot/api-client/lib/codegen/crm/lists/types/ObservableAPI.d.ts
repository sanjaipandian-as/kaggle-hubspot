...
export declare class ObservableListsApi {
    ...
    cancelConversionWithHttpInfo(listId: string, _options?: ConfigurationOptions): Observable<HttpInfo<void>>;
    cancelConversion(listId: string, _options?: ConfigurationOptions): Observable<void>;
    ...
    getConversionDetailsWithHttpInfo(listId: string, _options?: ConfigurationOptions): Observable<HttpInfo<PublicListConversionResponse>>;
    getConversionDetails(listId: string, _options?: ConfigurationOptions): Observable<PublicListConversionResponse>;
    ...
    scheduleOrUpdateConversionWithHttpInfo(listId: string, publicListConversionTime: PublicListConversionTime, _options?: ConfigurationOptions): Observable<HttpInfo<PublicListConversionResponse>>;
    scheduleOrUpdateConversion(listId: string, publicListConversionTime: PublicListConversionTime, _options?: ConfigurationOptions): Observable<PublicListConversionResponse>;
