...
class ObjectListsApi {
    ...
    getConversionDetailsWithHttpInfo(param, options) {
        return this.api.getConversionDetailsWithHttpInfo(param.listId, options).toPromise();
    }
    getConversionDetails(param, options) {
