...
class ListsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    cancelConversion(listId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "cancelConversion", "listId");
            }
    ...
    getConversionDetails(listId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "getConversionDetails", "listId");
            }
            const localVarPath = '/crm/v3/lists/{listId}/schedule-conversion'
                .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    scheduleOrUpdateConversion(listId, publicListConversionTime, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "scheduleOrUpdateConversion", "listId");
            }
            if (publicListConversionTime === null || publicListConversionTime === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "scheduleOrUpdateConversion", "publicListConversionTime");
            }
            const localVarPath = '/crm/v3/lists/{listId}/schedule-conversion'
                .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.PUT);
...
class ListsApiResponseProcessor {
    cancelConversionWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getConversionDetailsWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "PublicListConversionResponse", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    scheduleOrUpdateConversionWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "PublicListConversionResponse", "");
