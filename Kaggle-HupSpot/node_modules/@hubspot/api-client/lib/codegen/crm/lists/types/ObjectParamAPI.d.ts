...
export declare class ObjectListsApi {
    ...
    cancelConversionWithHttpInfo(param: ListsApiCancelConversionRequest, options?: ConfigurationOptions): Promise<HttpInfo<void>>;
    cancelConversion(param: ListsApiCancelConversionRequest, options?: ConfigurationOptions): Promise<void>;
    ...
    getConversionDetailsWithHttpInfo(param: ListsApiGetConversionDetailsRequest, options?: ConfigurationOptions): Promise<HttpInfo<PublicListConversionResponse>>;
    getConversionDetails(param: ListsApiGetConversionDetailsRequest, options?: ConfigurationOptions): Promise<PublicListConversionResponse>;
    ...
    scheduleOrUpdateConversionWithHttpInfo(param: ListsApiScheduleOrUpdateConversionRequest, options?: ConfigurationOptions): Promise<HttpInfo<PublicListConversionResponse>>;
    scheduleOrUpdateConversion(param: ListsApiScheduleOrUpdateConversionRequest, options?: ConfigurationOptions): Promise<PublicListConversionResponse>;
